          ...
          <div class="account-settings">
              <div class="user-profile">
                  <div class="user-avatar">
                      <img src="<?=base_url('assets/images/admin/individualview/profile.jpg')?>" alt="profile">
                  </div>
      ...
      <form class="form-right">
          ...
          <div class="click">
              ...
              <div class="d-md-flex m-0">
                  <a class="btn btn-primary" href="<?=base_url('admin/individualupdate')?>" role="button">Update</a>
              </div>
          </div>
      </form>
  </div>
  ...
  <style>
      ...
      * {
      ...
      body {
          ...
          background: url("<?= base_url('assets/images/admin/individualview/bg.png')?>");
          padding-top: 3rem;
      }
