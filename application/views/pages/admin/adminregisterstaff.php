 <div class="wrapper">
         ...
         <div class="account-settings">
             <div class="user-profile">
                 <div class="user-avatar">
                     <img src="<?= base_url('assets/images/admin/registerstaff/profile.jpg')?>" alt="profile">
                 </div>
     ...
     <form class="form-right">
         ...
         <a class="btn btn-primary" href="<?= base_url('')?>" role="button">Register</a>
     </form>
 </div>
 ...
 <style>
     ...
     * {
     ...
     body {
         ...
         background: url("<?= base_url('assets/images/admin/registerstaff/bg.png')?>");
         padding-top: 3rem;
     }
