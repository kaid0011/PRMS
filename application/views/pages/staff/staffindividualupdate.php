                    ...
                    <div class="account-settings">
                        <div class="user-profile">
                            <div class="user-avatar">
                                <img src="<?= base_url('assets/images/staff/individualupdate/profile.jpg') ?>" alt="profile">
                            </div>
                            <h5 class="user-name">Lorem Lorem</h5>
                        </div>
                        <label for="formFileSm" class="form-label text-primary"><strong>Change Image</strong></label>
                ...
                <div class="card-body">
                    <div class="row gutters">
                        <div class="d-flex justify-content-between">
                            ...
                            <!-- Delete Button -->
                            <input type="submit" class="m-0 btn btn-primary" name="action" value="Delete">
                        </div>
...
<style>
    * {
    ...
    body {
        ...
        height: 100%;
        position: relative;
        background: url("<?= base_url('assets/images/staff/individualupdate/bg.png') ?>");
    }
