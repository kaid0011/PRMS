                    ...
                    <div class="account-settings">
                        <div class="user-profile">
                            <div class="user-avatar">
                                <img src="<?=base_url('assets/images/staff/registerpatient/profile.jpg') ?>" alt="profile">
                            </div>
                            <h5 class="user-name">Lorem Lorem</h5>
                        </div>
                        <label for="formFileSm" class="form-label text-primary"><strong>Upload Image</strong></label>
                        <input class="form-control form-control-sm" id="formFileSm" type="file">
                        <!-- <div class="d-md-flex m-0 justify-content-center">
                            <a class="btn btn-primary" href="<?= base_url('')?>" role="button">View Consultations</a>
                        </div> -->
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row gutters">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <h6 class="mb-3 text-primary"><strong>Personal Details</strong></h6>
                        </div>
                    ...
                    <div class="click">
                        ...
                        <div class="d-md-flex m-0">
                            ...
                            <!-- <a class="btn btn-primary" href="<?=base_url('staff/viewpatient')?>" role="button">Register</a> -->
                        </div>
                    </div>
                </div>
            </div>
...
<style>
    * {
    ...
    body {
        ...
        height: 100%;
        position: relative;
        background: url("<?= base_url('assets/images/staff/registerpatient/bg.png') ?>");
    }
